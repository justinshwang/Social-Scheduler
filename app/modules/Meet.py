...
class Profile(object):
    def __init__(self, name, disturb, update_calendar, HOSTNAME):
        self.name = name
        self.calendar = Calendar(update_calendar, HOSTNAME)
...
class Calendar(object):
    ...
    def __init__(self, update, HOSTNAME):
        ...
        # create DB instance
        db = Database(HOSTNAME,"password", "user")
        if (update.lower() == "y"):
            db.update()

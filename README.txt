...
features for socializing. For example, a colored indicator will represent current availability (either available or not available) 
...
Implements python Sockets for communication. From IDE, the user can run the server.py file. Before launching clients, ensure that client IP matches that of server, then launch client.py
